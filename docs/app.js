...
const labs = [
    ...
    sections: {
      summaryCards: [
        ...
        },
        {
          ...
          title: "Практика 1.3",
          text: "В отчете показана только финальная версия кода, как и требует задание. При этом ниже есть ссылки на все этапы разработки: Lr1/practice_1_1, Lr1/practice_1_2 и Lr1/practice_1_3.",
        },
        {
          kicker: "Стек",
      ...
      timeline: [
        {
          ...
          folder: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_1`,
        ...
        },
        {
          ...
          folder: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_2`,
        ...
        },
        {
          ...
          folder: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3`,
      ...
      links: [
        {
          ...
          items: [
            ...
            { label: "Папка practice_1_1", href: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_1` },
            { label: "Папка practice_1_2", href: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_2` },
            { label: "Папка practice_1_3", href: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3` },
        ...
        },
        {
          ...
          text: "Для отчета используется итоговая версия ЛР1 из students/k3341/Dushchenko_Daniil/Lr1/practice_1_3, потому что в задании разрешено показывать только финальную версию кода.",
          items: [
            { label: "Финальный API", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3/app/main.py` },
            { label: "Финальные модели", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3/app/models.py` },
            { label: "Подключение к БД", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3/app/db.py` },
            { label: "alembic.ini", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3/alembic.ini` },
            { label: "env.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr1/practice_1_3/migrations/env.py` },
          ],
        },
      ],
      endpointGroups: [
  ...
  },
  {
    ...
    summary:
      "ЛР2 оформлена отдельной папкой students/k3341/Dushchenko_Daniil/Lr2/lab_2 и содержит 6 программ: три для вычислительной задачи и три для параллельного парсинга веб-страниц. Результаты парсинга сохраняются в PostgreSQL, а в отчете собраны реальные замеры времени и выводы.",
    metrics: [
    ...
    sections: {
      summaryCards: [
        ...
        },
        {
          ...
          text: "В students/k3341/Dushchenko_Daniil/Lr2/lab_2/REPORT.md уже внесены реальные результаты запуска на твоей машине. Для парсинга лучшим оказался async, а для формульной вычислительной задачи multiprocessing проиграл из-за накладных расходов.",
        },
      ],
      timeline: [
        {
          ...
          folder: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2`,
      ...
      links: [
        {
          ...
          items: [
            { label: "Папка lab_2", href: `${repoBase}/tree/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2` },
            { label: "Коммит lab_2", href: `${repoBase}/commit/4944971` },
            { label: "Отчет REPORT.md", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/REPORT.md` },
            { label: "README", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/README.md` },
          ],
        },
        {
          ...
          items: [
            { label: "task1_threading.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/task1_threading.py` },
            { label: "task1_multiprocessing.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/task1_multiprocessing.py` },
            { label: "task1_async.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/task1_async.py` },
            { label: "task2_threading.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/task2_threading.py` },
            { label: "task2_multiprocessing.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/task2_multiprocessing.py` },
            { label: "task2_async.py", href: `${repoBase}/blob/main/students/k3341/Dushchenko_Daniil/Lr2/lab_2/task2_async.py` },
          ],
        },
      ],
      endpointGroups: [
  ...
  hero.innerHTML = `
    <div class="hero-grid">
      <div>
        ...
        <p>
          Это страница отчета для публикации через GitHub Pages.
          Здесь собраны лабораторные работы по веб-разработке с описанием,
          ссылками на исходный код и финальными фрагментами реализации.
        </p>
      </div>
